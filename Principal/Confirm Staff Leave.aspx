<%@ Page Title="" Language="C#" MasterPageFile="~/Principal/MasterPage_Principal.master" AutoEventWireup="true" CodeFile="Confirm Staff Leave.aspx.cs" Inherits="Principal_Confirm_Staff_Leave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Text="Confirm Staff Leave"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
