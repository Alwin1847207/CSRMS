...
public partial class Principal_View_Student_Leave : System.Web.UI.Page
{
    ...
    protected void DropDownList3_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        string sql = "select * from absent inner join attendance on absent.atid=attendance.atid inner join department on department.did=attendance.did inner join student on student.sid=absent.sid where attendance.did=" + a+" and attendance.date='"+c+" and attendance.semid='"+b;
