<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/MasterPage_Teacher.master" AutoEventWireup="true" CodeFile="view_Student_Report.aspx.cs" Inherits="Teacher_view_Student_Report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <asp:Panel ID="Panel1" runat="server" style="margin-left: 0px">

    <table class="nav-justified">
    <tr>
        <td class="auto-style3">Select Student:</td>
        <td class="auto-style3">
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="136px">
            </asp:DropDownList>
        </td>
    ...
    <tr>
        ...
        <td class="auto-style7">
            <asp:Image ID="Image1" runat="server" Height="60px" Width="64px" />
        </td>
