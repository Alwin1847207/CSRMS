<%@ Page Title="" Language="C#" MasterPageFile="~/Head of Department/MasterPage_HOD.master" AutoEventWireup="true" CodeFile="View_Timetable.aspx.cs" Inherits="HOD_View_Timetable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="auto-style2">
            <asp:DropDownList ID="DropDownList_dep" runat="server" Height="55px" OnSelectedIndexChanged="DropDownList_dep_SelectedIndexChanged" Width="185px">
            </asp:DropDownList>
        </td>
        <td class="auto-style2">
    ...
    <tr>
        ...
        <td class="auto-style3">
            <asp:DropDownList ID="DropDownList_sem" runat="server" AutoPostBack="True" Width="178px" Height="52px">
            </asp:DropDownList>
        </td>
        <td class="auto-style3">
    ...
    <tr>
        ...
        <td rowspan="6" colspan="3">
            <asp:GridView ID="GridView_timetable" runat="server" OnSelectedIndexChanged="GridView_timetable_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Width="570px">
