<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage_Student.master" AutoEventWireup="true" CodeFile="View_Timetable.aspx.cs" Inherits="Student_View_Timetable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="auto-style2">&nbsp;</td>
        <td colspan="3">
            <asp:GridView ID="GridView_timetable" runat="server" OnSelectedIndexChanged="GridView_timetable_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Width="604px" Height="56px">
